...
IDTEST = ""  # Datatier ID replace with your actual datatier ID
...
if __name__ == "__main__":
    ...
    client.ensure_alias(alias=IDTEST, framework=DefaultDatastucts.MLFLOW)

    response = client.get_item_data(
        DefaultDatastucts.MLFLOW.value, IDTEST)  # Get the item data
